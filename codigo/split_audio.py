...
def get_segments(samples, raw_samples, sample_rate, samples_per_window, bytes_per_sample):
   segments = []
        ...
        if segment['is_speech']:
            ...
            if silencio >= 1:
                if primera and stop - start > 10000:
                    ...
                    wavfile.write("{}out-{}-{}.wav".format(output_path,start,stop), sample_rate, speech_samples)
                    count += 1
                    lista = []
                voz=0
                primera = 0
...
if __name__ == '__main__':
   ...
   bytes_per_sample = 2
   segments = get_segments(samples, raw_samples, sample_rate, samples_per_window, bytes_per_sample)
